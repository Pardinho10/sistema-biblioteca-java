...
public class BibliotecaServicio {
     ...
     */
    public Material buscarMaterialesPorTitulos(int id) {
     ...
     * Valida que el material esté disponible y que el usuario exista.
     */
    public int realizarPrestamo(int idUsuario, int idMaterial) throws 
        ...
        // Buscar usuario (lanza excepción si no existe)
